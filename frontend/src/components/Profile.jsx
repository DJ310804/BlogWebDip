          ...
          <div class="w-full xl:w-1/2 flex flex-col xl:flex-row justify-center">
            ...
            <ul class="mt-2  text-[#ffffff]">
                ...
                <li class="flex items-center border-b py-2 space-x-2">
                    ...
                    <a href="#" title="Facebook" class="text-gray-700 hover:text-gray-900">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 506.86 506.86" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" title="Twitter" class="text-gray-700 hover:text-gray-900">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 333333 333333" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" title="LinkedIn" class="text-gray-700 hover:text-gray-900">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 333333 333333" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" title="Github" class="text-gray-700 hover:text-gray-900">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
